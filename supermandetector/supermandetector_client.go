...
type SupermanDetectorClient struct {
	URL         string
...
// NewClient creates and returns a new HTTP client object for the SupermanDetector service
func NewClient(url string, transport http.RoundTripper) SupermanDetectorClient {
	return SupermanDetectorClient{url, transport, nil, nil, 0}
}

// AddCredentials adds the credentials to the client for subsequent requests.
func (client *SupermanDetectorClient) AddCredentials(header string, token string) {
	client.CredsHeader = &header
	client.CredsToken = &token
}

func (client SupermanDetectorClient) getClient() *http.Client {
	var c *http.Client
...
func (client SupermanDetectorClient) addAuthHeader(req *http.Request) {
...
func (client SupermanDetectorClient) httpGet(url string, headers map[string]string) (*http.Response, error) {
...
func (client SupermanDetectorClient) httpDelete(url string, headers map[string]string) (*http.Response, error) {
	hclient := client.getClient()
...
func (client SupermanDetectorClient) httpPut(url string, headers map[string]string, body []byte) (*http.Response, error) {
...
func (client SupermanDetectorClient) httpPost(url string, headers map[string]string, body []byte) (*http.Response, error) {
	var contentReader io.Reader
	if body != nil {
		contentReader = bytes.NewReader(body)
	}
...
func (client SupermanDetectorClient) httpPatch(url string, headers map[string]string, body []byte) (*http.Response, error) {
	var contentReader io.Reader
	if body != nil {
		contentReader = bytes.NewReader(body)
	}
...
func (client SupermanDetectorClient) httpOptions(url string, headers map[string]string, body []byte) (*http.Response, error) {
...
func (client SupermanDetectorClient) PostIpAccessRequest(request *IpAccessRequest) (*IpAccessResponse, error) {
	var data *IpAccessResponse
	url := client.URL + "/"
